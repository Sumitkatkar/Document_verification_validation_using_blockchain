		  ...
		  <div class="col-sm-12 col-md-8">
			<div class="row">
				<table align="center">
					...
					<tr>
						<td colspan="2"><b>Home Page <span>(by Best Company)</span></b></td>
					</tr>
            	</table>			
				...
				<table align="center" border="5" cellpadding="10" cellspacing="10">
					...
					<tr>
					 ...
					 <tr>
          			...
          			<tr>
					 	<td><b>View</b></td>
          				<td><a href="companyinfo?emailid=<%=rs.getString("emailid")%>" style="background: yellow;color: black;" class="button">Click Here</a></td>
           			</tr>
				<tr>
					 	<td><b>Transaction</b></td>
          				<td><a href="transaction?emailid=<%=rs.getString("emailid")%>" style="background: yellow;color: black;" class="button">Click Here</a></td>
           			</tr>
					 <%}
					  	i++;
					   } %>
