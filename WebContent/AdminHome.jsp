		...
		<div class="container"><br><br><br>
		 <div class="row">
		  <div class="col-sm-12 col-md-8">
			...
			<table align="center">
				<tr>
				<img src="images/home.jpg" alt="homepage" width="500" height="450">
			...
			<!-- 
				...
				<tr>
					<td align="center"> <span style="font-size:22px; color: red">(by Best Admin)</span></td>
				</tr>
			 -->
            </table>			
				</div>
				...
				<div class="col-sm-12 col-md-4">
					<tr> <img src="images/register.png" alt=""> </tr>
					<tr> <td><span style="font-size:22px; color: purple">  Welcome to Admin Section</span></td> </tr>
				</div>
			</div>
		</div>
	</section><br>
